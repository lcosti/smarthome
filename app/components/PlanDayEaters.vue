 ...
 * and dinner — where the table is a column of its own, because the roll-call is
 * a fact about the day rather than about any one of its meals. The card still
 * shows it in its footer at widths where it stands alone.
 *
