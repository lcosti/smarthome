...
export const useSyncStore = defineStore('sync', () => {
  const maps = {
    ...
    recipe_adaptations: ref(new Map<string, RecipeAdaptationRow>()),
    recipe_adaptation_items: ref(new Map<string, RecipeAdaptationItemRow>()),
