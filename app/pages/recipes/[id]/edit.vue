...
/**
 * The recipe as a typing job: rename it, reorder its lines, correct a figure.
 *
 * Reading it lives one level up at /recipes/[id], which is where a tap on the
 * library lands. This page is only ever reached on purpose — the pencil on the
 * view page, or a flow that just created something with blanks to fill (a typed
 * name, an import worth checking over).
 */
